...
import { listBuyerEntities } from "@/lib/repositories";
import { getSession } from "@/lib/session";

export const dynamic = "force-dynamic";

export default async function BuyerEntitiesPage() {
  ...
  return (
    ...
    >
      <Suspense
        fallback={<div className="mt-4 h-40 animate-pulse rounded-2xl border border-app-border/80 bg-app-surface/80" />}
      >
        <BuyerEntitiesManagement
          language={language}
          initialBuyerEntities={buyerEntities}
          canEdit={canEdit}
        />
      </Suspense>
    </AppShell>
