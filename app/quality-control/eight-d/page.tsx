...
export default async function QualityControlEightDPage() {
  ...
  return (
    <AppShell session={session} title={language === "en" ? "Quality Control · 8D Reports" : "质量管理 · 8D 报告"} description={language === "en" ? "Manage 8D problem solving for customer and field issues." : "管理客户与市场问题的 8D 问题解决流程。"}>
