...
import { createToolingEntry, listToolingEntries } from "@/lib/repositories";
...
export async function POST(request: Request) {
  ...
  try {
    const entry = await createToolingEntry({
      toolingCode,
      toolingName,
      toolingType,
      relatedSku,
    ...
    const msg = e instanceof Error ? e.message : "Create tooling entry failed";
