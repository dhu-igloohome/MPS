...
const LABELS = {
  en: {
    sectionTitle: "PO cash flow (from cost analysis)",
    tableHint:
    ...
    noCostData: "No cost analysis rows yet. Add them in the table above first.",
  ...
  zh: {
    ...
    noCostData: "暂无成本分析数据，请先在上方成本分析表中录入。",
...
export function PoCashFlowPanel({ language, initialEntries, costAnalysisEntries }: PoCashFlowPanelProps) {
